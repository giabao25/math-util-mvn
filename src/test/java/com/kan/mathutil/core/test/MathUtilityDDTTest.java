 ...
 */
package com.kan.mathutil.core.test;
...
public class MathUtilityDDTTest {
    ...
    // ta cần chuẩn bị bộ data để nhổi vào cái hàm qua 2 tham số đã chừa sẵn!!!
    ...
    public void verifyFactorialGivenRightArgument1ReturnsOk(int n, long expected) {
